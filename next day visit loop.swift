...
print(currentYear)
today.dateFormat = "MM"
var currentMonth = today.string(from: date)
today.dateFormat = "dd"
var currentDate = today.string(from: date)
...
func numberOfDaysForEachMonthInCurrentYear(for isLeapYear: Bool) -> [String]{
    if isLeapYear == false {
...
var numberOfdaysForEachMonth: [String] = numberOfDaysForEachMonthInCurrentYear(for: isLeapYear)
